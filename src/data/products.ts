...
export const products: Product[] = [
  // LICUADOS
  { id: 'lic-1', name: '90-60-90', price: 2.25, category: 'licuados', popular: true, emoji: '🥤' },
  { id: 'lic-2', name: 'Celia Cruz', price: 1.75, category: 'licuados', popular: true, emoji: '🌺' },
  { id: 'lic-3', name: 'Coco con Leche', price: 1.75, category: 'licuados', popular: true, emoji: '🥥' },
  { id: 'lic-4', name: 'Crispy con Leche', price: 1.50, category: 'licuados', emoji: '🍪' },
  { id: 'lic-5', name: 'Galleta con Leche', price: 1.75, category: 'licuados', popular: true, emoji: '🍪' },
  { id: 'lic-6', name: 'Leche con Zanahoria', price: 1.75, category: 'licuados', emoji: '🥕' },
  { id: 'lic-7', name: 'Licuado de Avena', price: 1.50, category: 'licuados', emoji: '🌾' },
  { id: 'lic-8', name: 'Licuado de Chocolate', price: 1.50, category: 'licuados', popular: true, emoji: '🍫' },
  ...
  { id: 'lic-11', name: 'Licuado de Granola', price: 1.50, category: 'licuados', emoji: '🥣' },
  { id: 'lic-12', name: 'Licuado de Guineo', price: 1.50, category: 'licuados', popular: true, emoji: '🍌' },
  { id: 'lic-13', name: 'Licuado de Naranja', price: 2.00, category: 'licuados', emoji: '🍊' },
  { id: 'lic-14', name: 'Licuado de Zapote', price: 1.50, category: 'licuados', emoji: '🫐' },
  { id: 'lic-15', name: 'Melón con Leche', price: 1.50, category: 'licuados', emoji: '🍈' },
  { id: 'lic-16', name: 'Naranja con Fresa', price: 2.50, category: 'licuados', popular: true, emoji: '🍊' },
  { id: 'lic-17', name: 'Naranja con Huevo', price: 2.25, category: 'licuados', emoji: '🥚' },
  { id: 'lic-18', name: 'Naranja con Papaya', price: 2.25, category: 'licuados', emoji: '🍊' },
  { id: 'lic-19', name: 'Naranja con Piña', price: 2.25, category: 'licuados', emoji: '🍍' },
  { id: 'lic-20', name: 'Naranja con Sandía', price: 2.25, category: 'licuados', emoji: '🍉' },
  { id: 'lic-21', name: 'Naranja con Zanahoria', price: 2.25, category: 'licuados', emoji: '🥕' },
  { id: 'lic-22', name: 'Naranja Melocotón', price: 2.25, category: 'licuados', emoji: '🍑' },
  { id: 'lic-23', name: 'Naranja con Kiwi', price: 2.25, category: 'licuados', emoji: '🥝' },
  { id: 'lic-24', name: 'Papaya con Leche', price: 1.50, category: 'licuados', emoji: '🥭' },
  { id: 'lic-25', name: 'Piña con Leche', price: 1.50, category: 'licuados', emoji: '🍍' },
  { id: 'lic-26', name: 'Sandía con Leche', price: 1.50, category: 'licuados', popular: true, emoji: '🍉' },
  ...
  { id: 'frz-5', name: 'Frappuccino Tradicional', price: 2.00, category: 'frozen', popular: true, emoji: '☕' },
  ...
  { id: 'frz-8', name: 'Frozen de Melón', price: 1.75, category: 'frozen', emoji: '🍈' },
  { id: 'frz-9', name: 'Frozen de Piña', price: 1.75, category: 'frozen', emoji: '🍍' },
  { id: 'frz-10', name: 'Frozen de Yogurt Kiwi', price: 2.25, category: 'frozen', emoji: '🥝' },
  { id: 'frz-11', name: 'Frozen Sandía', price: 1.75, category: 'frozen', emoji: '🍉' },
  { id: 'frz-12', name: 'Frozen Yogurt Fresa', price: 2.50, category: 'frozen', popular: true, emoji: '🍓' },
  { id: 'frz-13', name: 'Frozen Yogurt Melocotón', price: 2.25, category: 'frozen', emoji: '🍑' },
  { id: 'frz-14', name: 'Frozen de Yogurt Coco', price: 2.25, category: 'frozen', emoji: '🥥' },
  { id: 'frz-15', name: 'Jugo Puro Naranja', price: 2.50, category: 'frozen', emoji: '🍊' },
  { id: 'frz-16', name: 'Limonada con Fresa', price: 2.25, category: 'frozen', popular: true, emoji: '🍋' },
  { id: 'frz-17', name: 'Limonada con Kiwi', price: 1.75, category: 'frozen', emoji: '🥝' },
  { id: 'frz-18', name: 'Limonada con Melocotón', price: 1.75, category: 'frozen', emoji: '🍑' },
  ...
  { id: 'frz-21', name: 'Piña Colada', price: 1.75, category: 'frozen', emoji: '🍍' },
  { id: 'frz-22', name: 'Yogurt Piña', price: 2.25, category: 'frozen', emoji: '🍍' },
